      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Main headline - The Human Touch */}
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold mb-6 animate-slide-up stagger-1 leading-tight">
              <span className="text-foreground/80 block mb-2">4.7 Years. 11 Countries. Countless Solutions.</span>
              <span className="gradient-text block">Still Excited About Every Debug Session.</span>
            </h1>

            {/* Author name */}
            <p className="text-xl md:text-2xl text-muted-foreground mb-8 animate-slide-up stagger-2 font-medium">
              - Ashutosh Bhagwat
            </p>

            {/* Brief description */}
            <p className="text-lg text-foreground/70 max-w-2xl mx-auto mb-8 animate-slide-up stagger-3 leading-relaxed">
              Senior AI Engineer building production-grade systems across edge devices,
              backend infrastructure, and analytics platforms. Deployed Computer Vision solutions
              across 13,000+ devices spanning multiple continents.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-slide-up stagger-4">
              ...
              <Button asChild variant="outline" size="lg" className="px-8 hover:bg-primary/10 hover:border-primary transition-all">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="glass-card rounded-2xl p-8 md:p-12 text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button asChild size="lg" className="gradient-orange text-primary-foreground glow-hover">
                <Link to="/contact">
                  Get In Touch <ArrowRight className="ml-2 h-5 w-5" />
                </Link>
              </Button>
              <Button asChild variant="outline" size="lg" className="hover:bg-primary/10 hover:border-primary transition-all">
                <Link to="/resume">
